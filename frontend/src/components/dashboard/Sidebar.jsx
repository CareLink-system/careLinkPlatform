  ...
  return (
    <div className="h-full flex flex-col py-6">
      ...
      <div className="px-6 space-y-6 mt-4">
        ...
        {/* Perfect Figma Match "Go Pro" Card */}
        <div className="relative mt-12 rounded-[1.5rem] bg-[#2C2C2C] p-5 text-center text-white shadow-xl overflow-visible">
          ...
          <div className="absolute -top-[4.5rem] left-1/2 -translate-x-1/2 w-[120px] pointer-events-none">
          ...
          <div className="mt-14 relative z-10">
            ...
            <button onClick={close} className="mt-4 w-full rounded-lg bg-[#4B9AA8] py-2.5 text-xs font-bold text-white shadow-md transition-transform hover:scale-105 active:scale-95">
              Go Pro
            </button>
          </div>
        </div>
        ...
        <button
          ...
          className="flex w-full items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:bg-red-50 hover:text-red-600 transition-colors font-medium text-sm"
        >
