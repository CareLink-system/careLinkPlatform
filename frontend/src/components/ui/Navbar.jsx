		...
		>
			<div className="mx-auto w-full max-w-6xl px-4 py-3">
				<div className="flex items-center gap-4 bg-white/80 backdrop-blur-md border border-white/20 rounded-full px-4 py-2 shadow-lg">
					...
					<nav className="flex-1 hidden md:flex justify-center gap-6 text-sm text-primary">
					...
					<div className="flex items-center gap-3 ml-auto md:ml-0">
						<Link to="/auth/register" className="hidden md:inline-flex items-center px-4 py-2 rounded-full bg-accent text-white text-sm font-medium shadow hover:scale-[1.02] transition-transform">Get Started</Link>
				...
				{open && (
					<div className="md:hidden mt-2 w-full bg-white/80 backdrop-blur-md border border-white/20 rounded-xl p-3">
