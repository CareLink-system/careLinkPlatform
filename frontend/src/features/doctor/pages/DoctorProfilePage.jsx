...
// ✅ Moved OUTSIDE the component — prevents remount on every render
const Input = (props) => (
  <input
    {...props}
  ...
  return (
    <div className="flex justify-center w-full">
      ...
      >
        ...
        <Input name="specializationId" value={form.specializationId} onChange={handleChange} placeholder="Specialization ID" />
        ...
        <Input name="consultationFee" type="number" value={form.consultationFee} onChange={handleChange} placeholder="Consultation Fee" />
